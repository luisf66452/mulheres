export default function IlustracaoBotanica() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      <div className="ilustracao-cluster absolute -top-2 -right-2 w-72 sm:w-96 md:w-[30rem]">
        <img
      ...
      <div className="ilustracao-cluster absolute -bottom-2 -left-2 w-52 sm:w-64 md:w-72">
        <img
